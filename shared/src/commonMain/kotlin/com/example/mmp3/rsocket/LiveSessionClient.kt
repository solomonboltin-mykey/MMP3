...
import com.example.mmp3.models.Connection
import com.example.mmp3.models.TokenUserSession
import com.example.mmp3.models.getUserId
...
class LiveSessionClient(
    ...
    private val tokenUserHandler = TokenUserSession()
                            ...
                            buildPayload {
                                ...
                                data(
                                    format.encodeToString(
                                        ...
                                        Connection(userId, liveSessionId)
                                    )
                                )
                            }
                        }
